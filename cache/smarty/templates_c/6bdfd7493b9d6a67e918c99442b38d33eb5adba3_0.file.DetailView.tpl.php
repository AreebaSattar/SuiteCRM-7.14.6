...
/* Smarty version 4.5.3, created on 2025-02-03 10:45:58
  from 'C:\xampp\htdocs\crmn\SuiteCRM-7.14.6\cache\themes\SuiteP\modules\st_time_management\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_67a09056c2e133_42125092',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6bdfd7493b9d6a67e918c99442b38d33eb5adba3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crmn\\SuiteCRM-7.14.6\\cache\\themes\\SuiteP\\modules\\st_time_management\\DetailView.tpl',
      1 => 1738575958,
      2 => 'file',
    ),
  ),
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='st_time_management'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='st_time_management'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='st_time_management'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $_smarty_tpl->tpl_vars['APP']->value['NTC_DELETE_CONFIRMATION'];?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='st_time_management'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
<div class="col-xs-12 col-sm-12 detail-view-row-item" data-field="activity">
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="enum" field="activity" colspan='3'>

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['activity']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['activity']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['activity']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['activity']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['activity']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['activity']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['activity']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['activity']['options'][$_smarty_tpl->tpl_vars['fields']->value['activity']['value']];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="start_time">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="datetimecombo" field="start_time" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['start_time']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php if (strlen($_smarty_tpl->tpl_vars['fields']->value['start_time']['value']) <= 0) {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['start_time']['default_value']);
} else {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['start_time']['value']);
}?> 
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['start_time']['name'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['start_time']['value'];?>
</span>
<?php }?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="end_time">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="datetimecombo" field="end_time" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['end_time']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php if (strlen($_smarty_tpl->tpl_vars['fields']->value['end_time']['value']) <= 0) {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['end_time']['default_value']);
} else {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['end_time']['value']);
}?> 
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['end_time']['name'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['end_time']['value'];?>
</span>
<?php }?>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_DATE_ENTERED','module'=>'st_time_management'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_DATE_MODIFIED','module'=>'st_time_management'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['duration']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['duration']['name'];?>
">
<?php echo smarty_function_sugar_number_format(array('precision'=>0,'var'=>$_smarty_tpl->tpl_vars['fields']->value['duration']['value']),$_smarty_tpl);?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="st_time_management_accounts_name">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="st_time_management_accounts_name" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['st_time_management_accounts_name']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['st_time_management_accountsaccounts_ida']['value'])) {
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', "detail_url", null);?>index.php?module=Accounts&action=DetailView&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['st_time_management_accountsaccounts_ida']['value'];
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url'=>$_smarty_tpl->tpl_vars['detail_url']->value),$_smarty_tpl);?>
"><?php }?>
<span id="st_time_management_accountsaccounts_ida" class="sugar_field" data-id-value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['st_time_management_accountsaccounts_ida']['value'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['st_time_management_accounts_name']['value'];?>
</span>
<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['st_time_management_accountsaccounts_ida']['value'])) {?></a><?php }
}?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="st_time_management_users_name">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="st_time_management_users_name" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['st_time_management_users_name']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<span id="st_time_management_usersusers_ida" class="sugar_field" data-id-value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['st_time_management_usersusers_ida']['value'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['st_time_management_users_name']['value'];?>
</span>
<?php }?>
