...
/* Smarty version 4.5.3, created on 2025-02-03 08:30:32
  from 'C:\xampp\htdocs\crmn\SuiteCRM-7.14.6\cache\themes\SuiteP\modules\Opportunities\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_67a07098cdb351_25695212',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f280049f87cc3fc02eebbc584e1ffd55bdef1229' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crmn\\SuiteCRM-7.14.6\\cache\\themes\\SuiteP\\modules\\Opportunities\\EditView.tpl',
      1 => 1738567832,
      2 => 'file',
    ),
  ),
...
" accessKey="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_KEY'];?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=Opportunities'); return false;" type="button" name="button" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_LABEL'];?>
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_CURRENCY','module'=>'Opportunities'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
<span class="dateTime">
<?php $_smarty_tpl->_assignInScope('date_value', $_smarty_tpl->tpl_vars['fields']->value['date_closed']['value']);?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_closed']['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_closed']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['date_value']->value;?>
" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_closed']['name'];?>
...
<?php echo '<script'; ?>
 type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_closed']['name'];?>
",
form : "EditView",
...
",
button : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_closed']['name'];?>
_trigger",
singleClick : true,
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_AMOUNT','module'=>'Opportunities'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
<?php if (strlen($_smarty_tpl->tpl_vars['fields']->value['amount']['value']) <= 0) {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['amount']['default_value']);
} else {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['amount']['value']);
}?>  
<input type='text' name='<?php echo $_smarty_tpl->tpl_vars['fields']->value['amount']['name'];?>
' 
id='<?php echo $_smarty_tpl->tpl_vars['fields']->value['amount']['name'];?>
' size='30'  value='<?php echo smarty_function_sugar_number_format(array('var'=>$_smarty_tpl->tpl_vars['value']->value),$_smarty_tpl);?>
' title='' tabindex='0'
>
</div>
...
<select name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['opportunity_type']['name'];?>
"
id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['opportunity_type']['name'];?>
"
title=''              
>
<?php if ((isset($_smarty_tpl->tpl_vars['fields']->value['opportunity_type']['value']))) {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['opportunity_type']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['opportunity_type']['value']),$_smarty_tpl);?>

<?php } else {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['opportunity_type']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['opportunity_type']['default']),$_smarty_tpl);?>
...
<select name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['sales_stage']['name'];?>
"
id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['sales_stage']['name'];?>
"
title=''              
>
<?php if ((isset($_smarty_tpl->tpl_vars['fields']->value['sales_stage']['value']))) {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['sales_stage']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['sales_stage']['value']),$_smarty_tpl);?>

<?php } else {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['sales_stage']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['sales_stage']['default']),$_smarty_tpl);?>
...
<?php if (strlen($_smarty_tpl->tpl_vars['fields']->value['probability']['value']) <= 0) {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['probability']['default_value']);
} else {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['probability']['value']);
}?>  
<input type='text' name='<?php echo $_smarty_tpl->tpl_vars['fields']->value['probability']['name'];?>
' 
id='<?php echo $_smarty_tpl->tpl_vars['fields']->value['probability']['name'];?>
...
<input type='text' name='<?php echo $_smarty_tpl->tpl_vars['fields']->value['next_step']['name'];?>
'
id='<?php echo $_smarty_tpl->tpl_vars['fields']->value['next_step']['name'];?>
' size='30'
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'Opportunities'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
<?php echo $_smarty_tpl->tpl_vars['PROBABILITY_SCRIPT']->value;?>
...
<?php echo '<script'; ?>
 type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_OPPORTUNITY_NAME','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED_NAME','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'description', 'text', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DESCRIPTION','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'deleted', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DELETED','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_ID','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'opportunity_type', 'enum', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_TYPE','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'account_name', 'relate', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ACCOUNT_NAME','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'account_id', 'id', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ACCOUNT_ID','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'campaign_id', 'id', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CAMPAIGN_ID','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'campaign_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CAMPAIGN','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'lead_source', 'enum', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_LEAD_SOURCE','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'amount', 'currency', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_AMOUNT','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'amount_usdollar', 'currency', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_AMOUNT_USDOLLAR','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'currency_id', 'id', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CURRENCY','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'currency_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CURRENCY_NAME','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'currency_symbol', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CURRENCY_SYMBOL','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'date_closed', 'date', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DATE_CLOSED','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'next_step', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_NEXT_STEP','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'sales_stage', 'enum', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_SALES_STAGE','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidateRange('EditView', 'probability', 'int', false, '<?php echo smarty_function_sugar_translate(array('label'=>'LBL_PROBABILITY','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
', 0, 100);
addToValidate('EditView', 'jjwg_maps_address_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_JJWG_MAPS_ADDRESS','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'jjwg_maps_geocode_status_c', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_JJWG_MAPS_GEOCODE_STATUS','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'jjwg_maps_lat_c', 'float', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_JJWG_MAPS_LAT','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'jjwg_maps_lng_c', 'float', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_JJWG_MAPS_LNG','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'account_name', 'alpha', true,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_ACCOUNT_NAME','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
', 'account_id' );
addToValidateBinaryDependency('EditView', 'campaign_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_CAMPAIGN','module'=>'Opportunities','for_js'=>true),$_smarty_tpl);?>
', 'campaign_id' );
<?php echo '</script'; ?>
><?php echo '<script'; ?>
