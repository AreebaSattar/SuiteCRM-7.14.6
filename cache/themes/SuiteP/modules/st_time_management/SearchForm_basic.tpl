...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='activity_basic' >{sugar_translate label='LBL_ACTIVITY' module='st_time_management'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{html_options id='activity_basic' name='activity_basic[]' options=$fields.activity_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.activity_basic.value}
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='name_basic'> {sugar_translate label='LBL_NAME' module='st_time_management'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
<input type='text' name='{$fields.name_basic.name}'
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='st_time_management'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
